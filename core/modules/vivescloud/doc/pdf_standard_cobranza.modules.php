...
/**
 *  \file       core/modules/vivescloud/doc/pdf_standard.modules.php
 *  \ingroup    vivescloud
...
/**
 *	Class to manage PDF template standard_cobranza
 */
class pdf_standard_cobranza extends ModelePDFCobranza
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_COBRANZA_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->vivescloud->dir_output.'/cobranza')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->vivescloud->dir_output.'/cobranza';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->vivescloud->dir_output.'/cobranza/'.$objectref;
