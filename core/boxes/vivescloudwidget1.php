...
/**
 * \file    vivescloud/core/boxes/vivescloudwidget1.php
 * \ingroup vivescloud
 * \brief   Widget provided by Vivescloud
 *
 ...
 */
class vivescloudwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "vivescloudbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "vivescloud@vivescloud";
	 ...
	 */
	public $depends = array('vivescloud');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->vivescloud->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/vivescloud/class/vivescloud.class.php");

		// Populate the head at runtime
		$text = $langs->trans("VivescloudBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_vivescloud@vivescloud',
