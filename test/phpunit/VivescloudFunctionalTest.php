...
/**
 * \file    test/phpunit/VivescloudFunctionalTest.php
 * \ingroup vivescloud
...
/**
 * Class VivescloudFunctionalTest
 *
 ...
 *
 * @package Testvivescloud
 */
class VivescloudFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modVivescloud')->click();
		} else {
			// Disable the module
			$this->byHref('modVivescloud')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/vivescloud/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('vivescloud/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/vivescloud/admin/about.php');
		$this->authenticate();
		return $this->assertContains('vivescloud/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('vivescloudwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modVivescloud_VivescloudTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modVivescloud_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
